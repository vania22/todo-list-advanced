...
import './edit-container.styles.scss';

import EdiText from 'react-editext';

const EditContainer = ({text, onSave, onCancel, hint}) => {
    const [value, setValue] = useState(text);
    useEffect(() => setValue(text), [text]);

    const _onSave = (_value) => {
        if(value){
            setValue(value);
            onSave(_value)
        }
    ...
    return (
        <EdiText 
                    ...
                    onCancel={onCancel}
                    hint={hint}
                    viewContainerClassName='custom-view-container'
                    editContainerClassName='custom-input'
                    ...
                    cancelButtonContent={
                        <svg width="11" height="11" viewBox="0 0 11 11" fill="#fff" xmlns="http://www.w3.org/2000/svg">
